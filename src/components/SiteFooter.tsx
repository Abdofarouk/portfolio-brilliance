      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-3 lg:px-10">
        <div>
          <p className="font-display text-2xl tracking-tight">
            Let's build AI‑native telecom outcomes.
          </p>
          <p className="mt-3 max-w-sm text-sm text-muted-foreground">
            Open to leadership conversations on AI architecture, standards and operator transformation.
          </p>
        </div>
        <div className="grid grid-cols-2 gap-6 text-sm">
          <div>
            ...
            <ul className="mt-3 space-y-2">
              <li>
                <a className="hover:text-accent" href="mailto:abdelrahman@abdelkader-online.de">
